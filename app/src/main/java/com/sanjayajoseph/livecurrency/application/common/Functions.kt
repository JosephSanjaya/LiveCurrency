...
object Functions {
        ...
        when (type) {
            Constants.CANADIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.canadianCurrency != null && yesterdayCurrenciesData.currenciesRates?.canadianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.canadianCurrency!!, yesterdayCurrenciesData.currenciesRates?.canadianCurrency!!)
            ...
            Constants.HONGKONG_CURRENCY -> {
                if (currenciesData.currenciesRates?.hongkongCurrency != null && yesterdayCurrenciesData.currenciesRates?.hongkongCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.hongkongCurrency!!, yesterdayCurrenciesData.currenciesRates?.hongkongCurrency!!)
            ...
            Constants.ICELANDIC_CURRENCY -> {
                if (currenciesData.currenciesRates?.icelandicCurrency != null && yesterdayCurrenciesData.currenciesRates?.icelandicCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.icelandicCurrency!!, yesterdayCurrenciesData.currenciesRates?.icelandicCurrency!!)
            ...
            Constants.PHILIPPINE_CURRENCY -> {
                if (currenciesData.currenciesRates?.philippineCurrency != null && yesterdayCurrenciesData.currenciesRates?.philippineCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.philippineCurrency!!, yesterdayCurrenciesData.currenciesRates?.philippineCurrency!!)
            ...
            Constants.DANISH_CURRENCY -> {
                if (currenciesData.currenciesRates?.danishCurrency != null && yesterdayCurrenciesData.currenciesRates?.danishCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.danishCurrency!!, yesterdayCurrenciesData.currenciesRates?.danishCurrency!!)
            ...
            Constants.HUNGARIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.hungarianCurrency != null && yesterdayCurrenciesData.currenciesRates?.hungarianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.hungarianCurrency!!, yesterdayCurrenciesData.currenciesRates?.hungarianCurrency!!)
            ...
            Constants.CZECH_CURRENCY -> {
                if (currenciesData.currenciesRates?.czechCurrency != null && yesterdayCurrenciesData.currenciesRates?.czechCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.czechCurrency!!, yesterdayCurrenciesData.currenciesRates?.czechCurrency!!)
            ...
            Constants.BRITISH_CURRENCY -> {
                if (currenciesData.currenciesRates?.britishCurrency != null && yesterdayCurrenciesData.currenciesRates?.britishCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.britishCurrency!!, yesterdayCurrenciesData.currenciesRates?.britishCurrency!!)
            ...
            Constants.ROMANIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.romanianCurrency != null && yesterdayCurrenciesData.currenciesRates?.romanianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.romanianCurrency!!, yesterdayCurrenciesData.currenciesRates?.romanianCurrency!!)
            ...
            Constants.SWEDISH_CURRENCY -> {
                if (currenciesData.currenciesRates?.swedishCurrency != null && yesterdayCurrenciesData.currenciesRates?.swedishCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.swedishCurrency!!, yesterdayCurrenciesData.currenciesRates?.swedishCurrency!!)
            ...
            Constants.INDONESIA_CURRENCY -> {
                if (currenciesData.currenciesRates?.indonesiaCurrency != null && yesterdayCurrenciesData.currenciesRates?.indonesiaCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.indonesiaCurrency!!, yesterdayCurrenciesData.currenciesRates?.indonesiaCurrency!!)
            ...
            Constants.INDIA_CURRENCY -> {
                if (currenciesData.currenciesRates?.indianCurrecy != null && yesterdayCurrenciesData.currenciesRates?.indianCurrecy != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.indianCurrecy!!, yesterdayCurrenciesData.currenciesRates?.indianCurrecy!!)
            ...
            Constants.BRAZILLIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.brazillianCurrency != null && yesterdayCurrenciesData.currenciesRates?.brazillianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.brazillianCurrency!!, yesterdayCurrenciesData.currenciesRates?.brazillianCurrency!!)
            ...
            Constants.RUSSIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.russianCurrency != null && yesterdayCurrenciesData.currenciesRates?.russianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.russianCurrency!!, yesterdayCurrenciesData.currenciesRates?.russianCurrency!!)
            ...
            Constants.CROATIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.croatianCurrency != null && yesterdayCurrenciesData.currenciesRates?.croatianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.croatianCurrency!!, yesterdayCurrenciesData.currenciesRates?.croatianCurrency!!)
            ...
            Constants.JAPAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.japanCurrency != null && yesterdayCurrenciesData.currenciesRates?.japanCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.japanCurrency!!, yesterdayCurrenciesData.currenciesRates?.japanCurrency!!)
            ...
            Constants.THAI_CURRENCY -> {
                if (currenciesData.currenciesRates?.thaiCurrency != null && yesterdayCurrenciesData.currenciesRates?.thaiCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.thaiCurrency!!, yesterdayCurrenciesData.currenciesRates?.thaiCurrency!!)
            ...
            Constants.SWISH_CURRENCY -> {
                if (currenciesData.currenciesRates?.swishCurrency != null && yesterdayCurrenciesData.currenciesRates?.swishCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.swishCurrency!!, yesterdayCurrenciesData.currenciesRates?.swishCurrency!!)
            ...
            Constants.EUROPEAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.europeanCurrency != null && yesterdayCurrenciesData.currenciesRates?.europeanCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.europeanCurrency!!, yesterdayCurrenciesData.currenciesRates?.europeanCurrency!!)
            ...
            Constants.MALAYSIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.malaysianCurrency != null && yesterdayCurrenciesData.currenciesRates?.malaysianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.malaysianCurrency!!, yesterdayCurrenciesData.currenciesRates?.malaysianCurrency!!)
            ...
            Constants.BULGARIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.bulgarianCurrency != null && yesterdayCurrenciesData.currenciesRates?.bulgarianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.bulgarianCurrency!!, yesterdayCurrenciesData.currenciesRates?.bulgarianCurrency!!)
            ...
            Constants.TURKISH_CURRENCY -> {
                if (currenciesData.currenciesRates?.turkishCurrency != null && yesterdayCurrenciesData.currenciesRates?.turkishCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.turkishCurrency!!, yesterdayCurrenciesData.currenciesRates?.turkishCurrency!!)
            ...
            Constants.CHINESE_CURRENCY -> {
                if (currenciesData.currenciesRates?.chinaCurrency != null && yesterdayCurrenciesData.currenciesRates?.chinaCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.chinaCurrency!!, yesterdayCurrenciesData.currenciesRates?.chinaCurrency!!)
            ...
            Constants.NORWEGIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.norwegianCurrency != null && yesterdayCurrenciesData.currenciesRates?.norwegianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.norwegianCurrency!!, yesterdayCurrenciesData.currenciesRates?.norwegianCurrency!!)
            ...
            Constants.NEW_ZEALAND_CURRENCY -> {
                if (currenciesData.currenciesRates?.newZealandCurrency != null && yesterdayCurrenciesData.currenciesRates?.newZealandCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.newZealandCurrency!!, yesterdayCurrenciesData.currenciesRates?.newZealandCurrency!!)
            ...
            Constants.SOUTH_AFRICAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.southAfricanCurrency != null && yesterdayCurrenciesData.currenciesRates?.southAfricanCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.southAfricanCurrency!!, yesterdayCurrenciesData.currenciesRates?.southAfricanCurrency!!)
            ...
            Constants.US_CURRENCY -> {
                if (currenciesData.currenciesRates?.usCurrency != null && yesterdayCurrenciesData.currenciesRates?.usCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.usCurrency!!, yesterdayCurrenciesData.currenciesRates?.usCurrency!!)
            ...
            Constants.MEXICAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.mexicanCurrency != null && yesterdayCurrenciesData.currenciesRates?.mexicanCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.mexicanCurrency!!, yesterdayCurrenciesData.currenciesRates?.mexicanCurrency!!)
            ...
            Constants.SINGAPORE_CURRENCY -> {
                if (currenciesData.currenciesRates?.singaporeCurrency != null && yesterdayCurrenciesData.currenciesRates?.singaporeCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.singaporeCurrency!!, yesterdayCurrenciesData.currenciesRates?.singaporeCurrency!!)
            ...
            Constants.AUSTRALIAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.australianCurrency != null && yesterdayCurrenciesData.currenciesRates?.australianCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.australianCurrency!!, yesterdayCurrenciesData.currenciesRates?.australianCurrency!!)
            ...
            Constants.ISRAEL_CURRENCY -> {
                if (currenciesData.currenciesRates?.israelCurrency != null && yesterdayCurrenciesData.currenciesRates?.israelCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.israelCurrency!!, yesterdayCurrenciesData.currenciesRates?.israelCurrency!!)
            ...
            Constants.SOUTH_KOREAN_CURRENCY -> {
                if (currenciesData.currenciesRates?.southKoreanCurrency != null && yesterdayCurrenciesData.currenciesRates?.southKoreanCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.southKoreanCurrency!!, yesterdayCurrenciesData.currenciesRates?.southKoreanCurrency!!)
            ...
            Constants.POLAND_CURRENCY -> {
                if (currenciesData.currenciesRates?.polandCurrency != null && yesterdayCurrenciesData.currenciesRates?.polandCurrency != null) {
                    ...
                    tempEntity.diffValue = calculateChanges(currenciesData.currenciesRates?.polandCurrency!!, yesterdayCurrenciesData.currenciesRates?.polandCurrency!!)
    ...
    fun bundleDataToArray(currenciesData: CurrenciesResponse, yesterdayCurrenciesData:CurrenciesResponse, countryData: ArrayList<CountriesResponse>): ArrayList<CurrenciesEntity> {
        val currenciesDataList: ArrayList<CurrenciesEntity> = ArrayList()
        try{
            currenciesDataList.add(bundleDataToEntities(Constants.CANADIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.HONGKONG_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.ICELANDIC_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.PHILIPPINE_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.DANISH_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.HUNGARIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.CZECH_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.BRITISH_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.ROMANIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.SWEDISH_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.INDONESIA_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.INDIA_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.BRAZILLIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.RUSSIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.CROATIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.JAPAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.THAI_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.SWISH_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.EUROPEAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.MALAYSIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.BULGARIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.TURKISH_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.CHINESE_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.NORWEGIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.NEW_ZEALAND_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.SOUTH_AFRICAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.US_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.MEXICAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.SINGAPORE_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.AUSTRALIAN_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.ISRAEL_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.SOUTH_KOREAN_CURRENCY,currenciesData, yesterdayCurrenciesData, countryData))
            currenciesDataList.add(bundleDataToEntities(Constants.POLAND_CURRENCY, currenciesData, yesterdayCurrenciesData, countryData))
        }catch (e:Exception){
            Timber.tag(Constants.TAG).e(e.toString())
